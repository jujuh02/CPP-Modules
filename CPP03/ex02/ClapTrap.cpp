...
/*   Updated: 2023/11/30 16:28:56 by juhaamid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name, unsigned int hit, unsigned int energy, unsigned int _attack): hit(hit), energy(energy), _attack(_attack)
{
